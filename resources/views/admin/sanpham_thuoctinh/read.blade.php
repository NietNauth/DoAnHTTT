...
@section("do-du-lieu-tu-view")
    ...
    <div class="mb-4 flex items-center space-x-4">
        <form action="{{ url('sanpham-thuoctinh/search') }}" method="GET" class="flex space-x-2">
        ...
        <a href="{{ url('sanpham-thuoctinh/create') }}"

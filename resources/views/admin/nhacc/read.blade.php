...
@section("do-du-lieu-tu-view")
    ...
    <div class="mb-4 flex items-center space-x-4">
        <form action="{{ url('admin/nhacc/search') }}" method="GET" class="flex space-x-2">

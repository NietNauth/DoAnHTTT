...
@section("do-du-lieu-tu-view")
    ...
    <div class="mb-4 flex items-center space-x-4">
        <form action="{{ url('admin/nguoidung/search') }}" method="GET" class="flex space-x-2">
        ...
        <a href="{{ url('admin/nguoidung/create') }}" class="bg-blue-600 text-white px-4 py-2 rounded">
            + Thêm người dùng
        </a>
    </div>

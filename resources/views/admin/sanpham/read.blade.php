...
@section("do-du-lieu-tu-view")
    ...
    <div class="mb-4 flex items-center space-x-4">
        <form action="{{ url('admin/sanpham/search') }}" method="GET" class="flex space-x-2">
        ...
        <a href="{{ url('admin/sanpham/create') }}"

...
@section("content")
    <section id="category-product" class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            <h1 class="text-3xl md:text-4xl font-extrabold mb-8 text-gray-900">
                        ...
                        <div
                            ...
                            <div class="relative overflow-hidden">
                                ...
                                @if($product->isHot ?? false)
                                    <div
                                        class="absolute top-2 left-2 bg-linear-to-r from-pink-500 via-red-500 to-yellow-400 text-white text-xs font-semibold px-2 py-1 rounded-full shadow animate-pulse">
                                        Bán chạy
                                    </div>
                                @endif
                            </div>
                                        ...
                                        <div class="flex items-center gap-1 mt-1">
                                            @foreach($product->attributes as $attr)
                                                @if(!empty($attr->mauSac))
                                                    <span
                                                        class="w-4 h-4 rounded-full border border-gray-200 cursor-pointer hover:ring-1 hover:ring-[#55d5d2] transition-all duration-200"
